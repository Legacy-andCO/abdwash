...
export default function HomePage() {
  ...
  return (
    <><SiteHeader /><main><AccountDeletedNotice /><HomeBookingStatus />
      ...
      <ScrollReveal as="section" className="section shell" id="how-it-works"><div className="center-heading"><p className="eyebrow"><span /> {t("nav.how")}</p><h2>{t("home.howTitle")}</h2></div><ScrollReveal className="steps-grid" stagger><article><span className="step-icon">01</span><h3>{t("home.step1Title")}</h3><p>{t("home.step1Copy")}</p></article><article><span className="step-icon">02</span><h3>{t("home.step2Title")}</h3><p>{t("home.step2Copy")}</p></article><article><span className="step-icon">03</span><h3>{t("home.step3Title")}</h3><p>{t("home.step3Copy")}</p></article></ScrollReveal></ScrollReveal>
      <HomeReviews />
      <ScrollReveal as="section" className="final-cta"><div className="shell"><p className="eyebrow light"><span /> {t("home.ready")}</p><h2>{t("home.ctaTitle")}</h2><p>{t("home.ctaCopy")}</p><Link className="button button-light" href="/book">{t("home.start")} <span className="directional-icon" aria-hidden="true">→</span></Link></div></ScrollReveal>
    </main><SiteFooter /></>
  );
}
